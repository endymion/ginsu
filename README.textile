...
configure.slices << { :search => '//h3/a[@class="m"]', :static => 'index.html', :partial => 'header' }</pre></code>
...
Ginsu::Knife.configure do |configure|
	...
	configure.source = '/home/webproject/site'

	configure.slices << { :search => '#header', :static => 'index.html', :partial => 'header' }
	configure.slices << { :search => '#footer', :static => 'index.html', :partial => 'footer' }

	configure.links << { :static => 'galleries' }
	configure.links << { :static => 'news' }
