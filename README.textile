...
<pre><code># Use the index.html file as a Rails page
ginsu.page << { :static => 'index.html', :page => 'index' }
...
ginsu.partials << { :search => '//h3/a[@class="l"]', :static => 'index.html', :partial => 'header' }
...
Ginsu::Knife.configure do |ginsu|
  ...
  ginsu.pages << { :static => 'index.html', :page => 'index' }
  ginsu.pages << { :static => 'folder/index.html', :page => 'controller/index' }
